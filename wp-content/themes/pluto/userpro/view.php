<div class="userpro userpro-<?php echo $i; ?> userpro-id-<?php echo $user_id; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-centered <?php if (isset($header_only)) { echo 'userpro-centered-header-only'; } ?>">
		...
		<?php } else { ?>
		<div class="userpro-profile-img" data-key="profilepicture"><?php echo get_avatar( $user_id, '140' ); ?></div>
		<?php } ?>
		<div class="userpro-profile-img-after">
			<div class="userpro-profile-name">
				...
				<div class="custom-social"><?php echo $userpro->show_social_bar( $args, $user_id, 'userpro-centered-icons' ); ?></div>
			</div>
		...
		<div class="userpro-profile-icons top">
			<?php 
			$youtube_channel = userpro_profile_data('youtube_channel', $user_id);
			$twitch_channel = userpro_profile_data('twitch_channel', $user_id);
			if(!empty($youtube_channel)) { ?>
				<div class="channel-button"><a href="<?php echo $youtube_channel; ?>"><img src="http://shellmc.net/wp-content/uploads/2015/03/youtube.png"/></a></div>
			<?php } if(!empty($twitch_channel)) { ?>
			<div class="channel-button"><a href="<?php echo $twitch_channel; ?>"><img src="http://shellmc.net/wp-content/uploads/2015/03/twitch.png"/></a></div>
			<?php } ?>
